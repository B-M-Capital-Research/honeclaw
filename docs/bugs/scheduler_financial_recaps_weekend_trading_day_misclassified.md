...
- `data/sessions.sqlite3` -> `session_messages`
  - `2026-07-26T17:32:42.641630+08:00`
    - `session_id=Actor_feishu__direct__ou_5f636d6d7c80d333e41b86ae79d07adca8`
    - Feishu direct / scheduler actor 的跨市场复盘正常收口，但在北京时间 2026-07-26 周日写出 `今天（周日）A股和港股休市。最近交易日为7月25日（周五）`。实际 2026-07-25 是周六，A/H 最近完整交易日不应写成 7/25 周五。
  - `2026-07-26T17:55:19.150823+08:00`、`2026-07-26T18:33:39.187222+08:00`
    - Web canary direct 对 `周五美股为什么暴跌` / `HIMS周五为什么大跌` 已能收口，但仍把 `provider 北京时间 2026-07-25 04:00` 这种内部报价时间放入用户可见“本轮最近可得 quote”口径，并反复写“是否开市及具体交易时段仍以本轮行情证据为准”；相较此前通用失败已改善，但交易日 / 报价源时间表达仍偏技术口径。
  - 本轮 2026-07-26 15:00-19:02 CST 对照：`session_messages` 新增 36 条 user / 34 条 assistant / 2 条 system compact，覆盖 29 个更新 session；相关回复均已生成和送达，问题主要影响金融时间口径与正文可信度；不影响直聊 / 调度 / 投递主功能链路，因此维持质量性 `P3 / New`，非 P1，不创建 GitHub Issue。
  ...
  - `2026-07-26T06:02:32.887683+08:00`
    ...
    - assistant final 正常收口，但写出 `代表 2026-07-24（周四）收盘最新可得数据`、`每日美股盘后收盘复盘 | 2026-07-24（周四）夜校 / 2026-07-25（周五凌晨）延伸分析`，还把 `周四收盘`、`周五盘前`、`周四夜校/Fri延伸交易` 混在同一复盘里。
    - 实际 2026-07-24 是星期五；北京时间 2026-07-26 06:00 是周日早晨，应该明确最近一个美股交易日是 2026-07-24 周五收盘，而不是把同一日期标成周四或夜校。
  - `2026-07-26T06:17:12.586399+08:00`
    - `session_id=Actor_feishu__direct__ou_5f58ff884640e647a1792f618f45209251`
    - 用户短问 `周五暴跌`，assistant final 正常收口，但写出 `周五（7/24）美股整体跌幅有限`，随后又称 `真正大跌发生在前一日周四（7/23）`。由于 2026-07-24 是周五，`前一日周四（7/23）` 的星期 / 日期组合错误，会污染用户对波动发生日和交易日的理解。
    - 2026-07-26 代码复核纠正上述巡检判断：`2026-07-23` 的确是周四，日期 / 星期组合本身没有错；真实缺陷是用户问周五后，回答在确认周五宽基跌幅有限时没有澄清用户观察的是宽基、板块还是个股，而是静默改答成周四的大跌原因。该样本因此作为“目标时段 / 市场范围偷换”的相邻 Interactive 证据，而不是星期计算错误证据；scheduler 自身的错误星期样本仍由同文档其它记录证明。
  - 本轮 2026-07-26 03:01-07:05 CST 对照：`session_messages` 新增 3 条 user / 4 条 assistant，覆盖 3 个更新 session；assistant final 污染扫描未见 `<think>`、本机路径、原始 provider 错误、panic、stream 原始错误或 raw tool JSON 正文外泄。上述样本调度、生成、落库和投递均完成，问题主要影响金融复盘时间口径与正文可信度；不影响直聊 / 调度 / 投递主功能链路，因此维持质量性 `P3 / New`，非 P1，不创建 GitHub Issue。
  ...
  - `2026-07-20T17:31:09.746120+08:00`
    ...
    - 实际 2026-07-20 是周一，2026-07-18 是周六，2026-07-17 是周五；回复把 A股/港股开市日错判为休市，并据此生成跨市场复盘和美股预判。
    - 同窗对照：15:05-19:02 CST `session_messages` 新增 7 条 user / 6 条 assistant / 2 条 system compact，覆盖 3 个更新 session，全部以 assistant 收口；assistant final 污染扫描未见 `<think>`、本机路径、raw tool、provider 原始错误或 fenced JSON 外泄。该样本调度、生成、落库和投递均完成，问题主要影响金融复盘时间口径与正文 polish；不影响直聊 / 调度 / 投递主功能链路，因此维持质量性 `P3 / New`，非 P1，不创建 GitHub Issue。
  ...
  - `2026-07-19T17:32:49.408506+08:00`
    ...
    - 实际 2026-07-18 是星期六，2026-07-17 是星期五；回复虽能说明 7月19日周日休市，但后续最近交易日 / 星期口径错误，并据此生成跨市场复盘和下周判断。
    - 同窗对照：15:03-19:01 CST `session_messages` 新增 14 条 user / 6 条 assistant / 4 条 system compact，6 个更新 session 全部以 assistant 收口；assistant final 污染扫描未见 `<think>`、本机路径、raw tool、provider 原始错误或 fenced JSON 外泄。
    - 该样本调度、生成、落库和投递均完成，问题主要影响金融复盘时间口径与正文 polish；不影响直聊 / 调度 / 投递主功能链路，因此维持质量性 `P3 / New`，非 P1，不创建 GitHub Issue。
  - `2026-07-14T20:30:21.642897+08:00`
    - `session_id=Actor_feishu__direct__ou_5f79ee8185333e5db4a55e5eca0d8d2f7e`
    - Feishu scheduler `每日美股大盘风险仪表盘` 正常收口，但 assistant final 写出 `当前北京时间：2026年7月14日20:30。今天是周二，美股常规盘已收盘；本次以2026年7月11日周五收盘数据为准（7月12日、13日为周末休市）`。
    - 实际北京时间 2026-07-14 20:30 对应美东周二 08:30 左右盘前，不是常规盘收盘后；2026-07-13 是周一，不应写成周末休市。
    - 回复正常收口并完成风险仪表盘正文，问题主要影响交易日 / 数据新鲜度可信度，维持质量性 `P3 / New`，非 P1。
  - `2026-07-14T08:00:47.435877+08:00`
    - `session_id=Actor_feishu__direct__ou_5fe31244b1208749f16773dce0c822801a`
    - Feishu scheduler `每日宏观与AI早报` 在北京时间 2026-07-14 08:00 继续把大盘事实写成 `7月11日收盘`，同时又称“昨日美股标普+0.52%、纳指+0.65%”和“今日08:30 ET公布6月CPI（市场预期3.1%，前值3.8%）”，时间 / 事件口径混杂，降低金融早报可信度。
  - `2026-07-14T08:30:34.415787+08:00`
    - `session_id=Actor_feishu__direct__ou_5f995a704ab20334787947a366d62192f7`
    - Feishu scheduler `A股盘前高景气产业链推演` 写出 `美股最新完整交易日为2026年7月11日`，但同时引用“昨夜美股NVDA期货守住210美元”和 A 股 7 月 13 日盘面，继续说明普通 scheduler 的交易日 / 隔夜口径仍会漂移。
  - `2026-07-14T09:00:50.453075+08:00`
    - `session_id=Actor_feishu__direct__ou_5fe09f5f16b20c06ee5962d1b6ca7a4cda`
    - Feishu scheduler `早9点市场复盘(XME及加密ETF)` 用繁体中文输出，同时把 `7月11日美股收盘口径`、`7月10日 CPI 公布后`、`7月13日盘前口径` 混合进一条 09:00 早报，并写出明显高风险指数 / ETF 数值如 `S&P 500 約7,580`、`QQQ 726.31`、`IWM 3,003`。
  - 同窗对照：07:01-11:01 CST 共 32 个 user turn / 44 条 assistant 记录，Feishu / Web / Discord 均有 assistant 终态；上述样本正常收口，没有投递失败、错投、内部路径或原始工具 JSON 外泄。问题仍主要影响金融复盘日期、星期、事件和行情新鲜度口径，因此维持质量性 `P3 / New`，非 P1。
...
- `data/sessions.sqlite3`
  ...
  - 12:01 Feishu scheduler / direct actor session `Actor_feishu__direct__ou_5f39103ac18cf70a98afc6cfc7529120e5` 的 `每日公司资讯与分析总结` 在北京时间周日继续用 2026-07-24 美股收盘口径输出“今日核心事件”和“4天后（7月30日）发布 Q2 财报”等相对时间，没有明确隔离周末无新交易日的边界。
  - 14:48 Feishu direct ORCL 问答正确标注报价源为 2026-07-25 04:00 北京时间，但随后把该收盘快照组织成“当日（7/24）跌”和“刷新52周新低”等强时效叙述，用户容易误解为周日实时下跌。
- 本轮判断
  - 最新证据仍是金融回复在周末窗口对“今日 / 当日 / 最新”口径约束不稳，和既有普通 scheduler 金融复盘时间口径缺陷同源。
  - 为何不影响功能链路，因此定级为 P3：回复正常生成并送达，主体内容可读，但时间口径和交易日边界降低金融判断可信度。状态维持质量性 `P3 / New`，非 P1。
