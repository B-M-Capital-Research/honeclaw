...
- progress: 2026-05-23 patrol moved the invite-list prepend/replace transforms into `settings-model` with tests. The invite CRUD side effects and panel/component split remain open.
