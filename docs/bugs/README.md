...
| Heartbeat 定时任务结构化状态退化后被静默跳过，监控提醒可能长期失效 | P2 | New | 2026-04-17 10:30 再次扩散到 `全天原油价格3小时播报` 与 `Monitor_Watchlist_11`；11:00 三条 heartbeat 又恢复为 `JsonNoop`，协议抖动仍持续 | [scheduler_heartbeat_unknown_status_silent_skip.md](./scheduler_heartbeat_unknown_status_silent_skip.md) |
