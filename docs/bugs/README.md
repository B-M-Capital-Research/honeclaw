...
| Heartbeat 定时任务结构化状态退化后被静默跳过，监控提醒可能长期失效 | P2 | New | 2026-04-27 03:01 最新窗口仍未恢复：最近一小时无新直聊样本，03:00 heartbeat 继续在 `JsonEmptyStatus` 与 `PlainTextSuppressed` 间漂移，且没有任何任务恢复成纯 JSON 首包 | [scheduler_heartbeat_unknown_status_silent_skip.md](./scheduler_heartbeat_unknown_status_silent_skip.md) |
