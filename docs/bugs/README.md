...
| 原油定时播报把未核验地缘叙述当作油价事实送达用户 | P2 | New | 2026-04-22 09:01 `全天原油价格3小时播报` 再次 `completed + sent`，正文继续把 Trump 伊朗讲话、布伦特冲高至 `$109`、OPEC+ 与地缘风险当作确定性驱动发送；市场播报缺少来源质量与置信度门禁 | [oil_price_scheduler_geopolitical_hallucination.md](./oil_price_scheduler_geopolitical_hallucination.md) |
