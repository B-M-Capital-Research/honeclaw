...
| Heartbeat 定时任务遇到 `JsonUnknownStatus` 时静默跳过，监控提醒可能长期失效 | P2 | New | 2026-04-15 20:01 最近一小时仍在复现；`Monitor_Watchlist_11` 于 `19:01`、`20:01` 连续被静默吞掉，`19:31` 还扩散到 `全天原油价格3小时播报` | [scheduler_heartbeat_unknown_status_silent_skip.md](./scheduler_heartbeat_unknown_status_silent_skip.md) |
