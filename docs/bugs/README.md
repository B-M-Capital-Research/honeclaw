...
| Heartbeat 定时任务结构化状态退化后被静默跳过，监控提醒可能长期失效 | P2 | New | 2026-04-26 19:30/20:00 两个连续窗口已扩大成批量失败：`Monitor_Watchlist_11`、`TEM/ORCL/ASTS` 心跳、原油播报等多条任务连续落成 `execution_failed + skipped_error`，说明 heartbeat 公共 JSON 契约仍在生产失效 | [scheduler_heartbeat_unknown_status_silent_skip.md](./scheduler_heartbeat_unknown_status_silent_skip.md) |
