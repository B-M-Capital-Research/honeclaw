...
| Heartbeat 定时任务结构化状态退化后被静默跳过，监控提醒可能长期失效 | P2 | New | 2026-04-18 06:01 最新窗口仍未收口：`Monitor_Watchlist_11` 在 `05:31` 与 `06:01` 连续失败，`全天原油价格3小时播报` 于 `05:31` 被同根因击中后仅在 `06:01` 暂时恢复 | [scheduler_heartbeat_unknown_status_silent_skip.md](./scheduler_heartbeat_unknown_status_silent_skip.md) |
