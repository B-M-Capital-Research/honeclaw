...
- [x] Require the live initialize identity to match `codex-acp` or `opencode`, reject mismatched/missing names before session creation, and apply the unknown-major fail-closed policy to the Codex CLI companion as well as both adapters.
