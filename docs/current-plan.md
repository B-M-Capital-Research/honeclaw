...
- **Canonical Config 与 Runtime Apply 统一改造**
  ...
  - 摘要：canonical config、effective-config、CLI 管理面、安装 / onboarding、标准 Homebrew tap 与 OpenCode 本机配置继承已落地；desktop bundled 模式下的 live/component/full apply 语义与剩余迁移收尾仍在继续
