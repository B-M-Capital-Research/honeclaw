...
- Verification: Regression coverage includes RKLB/NBIS/RMBS/INTL/HONE casing and punctuation; BRK classes, A/H/JP/KR symbols, selected index aliases, crypto pairs; numeric ambiguity and per-span hints; names such as Rocket Lab, Ford, AT&T, and Johnson & Johnson; URL/path and acronym negatives; scheduled-condition/cadence negatives; provider URL encoding; live exact search/profile/quote/financial/fund/index/crypto probes; full channel tests; and production restart/health/E2E evidence.
