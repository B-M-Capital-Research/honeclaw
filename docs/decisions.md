...
- Status: Accepted
- Supersedes: The explicit-ticker search-first/profile-fallback sequence in `D-2026-07-17-03`. Its entity-first, exact-symbol, same-symbol quote, deep-intent, and auxiliary-integrity requirements remain active.
