//! Stage 120 chain-external first-execution authorization review for one exact Stage 119
//! observation-ledger-transition runner specification.
//!
...
//! artifact itself. Approval expires after 24 hours and only exposes one future Stage 121
//! claim-first attempt candidate. This module never executes the artifact, mounts or reads a Stage
//! 114 admitted input, creates a candidate output, or grants ledger/portfolio/trading power.
...
use super::historical_outcome_offline_dataset_feature_label_join_target_training_sealed_holdout_evaluation_controlled_shadow_experiment_forward_observation_first_natural_forward_cycle_observation_ledger_transition_isolated_runners::{
    ControlledShadowObservationLedgerTransitionIsolatedRunnerRecord,
    observation_ledger_transition_runners_for_first_execution_authorization_review,
    validate_observation_ledger_transition_isolated_runner_for_review,
};
use crate::state::AppState;

const REGISTRY_SCHEMA_VERSION: &str = "hone-controlled-shadow-observation-ledger-transition-first-execution-authorization-registry-v1";
const MANIFEST_SCHEMA_VERSION: &str =
    "hone-controlled-shadow-observation-ledger-transition-reproduced-artifact-manifest-v1";
const REVIEW_SCHEMA_VERSION: &str = "hone-controlled-shadow-observation-ledger-transition-first-execution-authorization-review-v1-server-rehashed-artifact";
const POLICY_VERSION: &str = "hone-controlled-shadow-observation-ledger-transition-first-execution-authorization-v1-server-rehashed-single-use-24h";
...
const NEXT_GATE: &str = "stage_121_claim_first_observation_ledger_transition_execution_attempt";

#[derive(Debug, Clone, Serialize, Deserialize, PartialEq, Eq)]
#[serde(rename_all = "snake_case")]
pub(crate) enum ControlledShadowObservationLedgerTransitionFirstExecutionAuthorizationVerdict {
    ApprovedForOneFutureClaimFirstObservationLedgerTransitionAttempt,
    ChangesRequestedRebuildArtifact,
    Rejected,
}

#[derive(Debug, Clone, Serialize, Deserialize, PartialEq, Eq)]
pub(crate) struct ControlledShadowObservationLedgerTransitionReproducedArtifactManifest {
    ...
    pub stage_114_admitted_input_was_not_read: bool,
}

#[derive(Debug, Clone, Serialize)]
pub(crate) struct ControlledShadowObservationLedgerTransitionArtifactInspection {
    pub custody_locator: String,
    pub manifest_present: bool,
    pub artifact_present: bool,
    pub manifest: Option<ControlledShadowObservationLedgerTransitionReproducedArtifactManifest>,
...
pub(crate) struct ReviewControlledShadowObservationLedgerTransitionFirstExecutionAuthorizationRequest
{
    ...
    rationale: String,
    exact_current_stage_51_through_stage_119_binding_confirmed: bool,
    reviewer_independent_from_stage_119_builder_and_complete_prior_chain_confirmed: bool,
    ...
    all_eight_observation_ledger_transition_functions_and_canonical_schemas_remain_bound_confirmed:
        bool,
    ...
    fixed_unprivileged_identity_read_only_root_ephemeral_workdir_and_resource_limits_confirmed:
        bool,
    future_input_only_stage_114_admitted_read_only_content_addressed_output_confirmed: bool,
    ...
    future_financial_events_require_separately_admitted_opening_snapshot_confirmed: bool,
    future_attempt_limited_to_non_financial_notice_candidate_without_authoritative_state_confirmed:
        bool,
    provider_publication_time_remains_unverified_until_separate_evidence_confirmed: bool,
    authorization_single_use_24_hour_expiry_and_stage_121_claim_separation_confirmed: bool,
    no_runtime_entrypoint_mount_input_read_observation_ledger_transition_execution_or_candidate_output_confirmed:
        bool,
    ...
    no_authoritative_ledger_event_position_cash_nav_performance_model_metric_training_reward_order_broker_or_trading_confirmed:
        bool,
    approval_only_opens_future_stage_121_claim_first_attempt_confirmed: bool,
    no_unconfirmed_hari_or_old_wang_logic_claimed: bool,
}

#[derive(Debug, Clone, Serialize, Deserialize, PartialEq, Eq)]
pub(crate) struct ControlledShadowObservationLedgerTransitionFirstExecutionAuthorizationReview {
    pub schema_version: String,
    ...
    pub runner: ControlledShadowObservationLedgerTransitionIsolatedRunnerRecord,
    pub artifact_manifest: ControlledShadowObservationLedgerTransitionReproducedArtifactManifest,
    ...
    pub verdict: ControlledShadowObservationLedgerTransitionFirstExecutionAuthorizationVerdict,
    pub rationale: String,
    pub exact_current_stage_51_through_stage_119_binding_confirmed: bool,
    pub reviewer_independent_from_stage_119_builder_and_complete_prior_chain_confirmed: bool,
    ...
    pub all_eight_observation_ledger_transition_functions_and_canonical_schemas_remain_bound_confirmed:
        bool,
    ...
    pub fixed_unprivileged_identity_read_only_root_ephemeral_workdir_and_resource_limits_confirmed:
        bool,
    pub future_input_only_stage_114_admitted_read_only_content_addressed_output_confirmed: bool,
    pub future_output_content_addressed_create_once_untrusted_and_independently_validated_confirmed:
        bool,
    pub opening_portfolio_snapshot_absent_and_financial_event_allowlist_empty_confirmed: bool,
    pub future_financial_events_require_separately_admitted_opening_snapshot_confirmed: bool,
    pub future_attempt_limited_to_non_financial_notice_candidate_without_authoritative_state_confirmed:
        bool,
    pub provider_publication_time_remains_unverified_until_separate_evidence_confirmed: bool,
    pub authorization_single_use_24_hour_expiry_and_stage_121_claim_separation_confirmed: bool,
    pub no_runtime_entrypoint_mount_input_read_observation_ledger_transition_execution_or_candidate_output_confirmed:
        bool,
    ...
    pub no_authoritative_ledger_event_position_cash_nav_performance_model_metric_training_reward_order_broker_or_trading_confirmed:
        bool,
    pub approval_only_opens_future_stage_121_claim_first_attempt_confirmed: bool,
    pub no_unconfirmed_hari_or_old_wang_logic_claimed: bool,
    pub one_shot_execution_attempt_limit: u8,
    pub one_future_claim_first_observation_ledger_transition_attempt_authorized: bool,
    ...
    pub candidate_output_created: bool,
...
#[derive(Debug, Clone, Serialize)]
pub(crate) struct ControlledShadowObservationLedgerTransitionFirstExecutionAuthorizationItem {
    pub runner: ControlledShadowObservationLedgerTransitionIsolatedRunnerRecord,
    pub artifact_inspection: ControlledShadowObservationLedgerTransitionArtifactInspection,
    pub latest_review:
        Option<ControlledShadowObservationLedgerTransitionFirstExecutionAuthorizationReview>,
    pub authorization_unexpired: bool,
    pub future_claim_eligible: bool,
}

#[derive(Debug, Clone, Serialize)]
pub(crate) struct ControlledShadowObservationLedgerTransitionFirstExecutionAuthorizationRegistry {
    pub schema_version: String,
    pub policy_version: String,
    pub items: Vec<ControlledShadowObservationLedgerTransitionFirstExecutionAuthorizationItem>,
...
#[derive(Debug, Clone)]
pub(crate) struct ControlledShadowObservationLedgerTransitionFirstExecutionAuthorizationReadinessSummary
{
    pub runner_count: usize,
    pub artifact_verified_runner_count: usize,
    pub artifact_pending_runner_count: usize,
...
#[derive(Debug, Clone)]
#[allow(dead_code)]
pub(crate) struct ApprovedControlledShadowObservationLedgerTransitionFirstExecutionAuthorization {
    pub runner: ControlledShadowObservationLedgerTransitionIsolatedRunnerRecord,
    pub review: ControlledShadowObservationLedgerTransitionFirstExecutionAuthorizationReview,
}

pub(crate) async fn handle_get_controlled_shadow_observation_ledger_transition_first_execution_authorizations(
    ...
    match build_registry(&state, Utc::now()).await {
        ...
        Err(error) => {
            warn!(%error, "observation ledger transition first-execution authorization registry failed");
            crate::routes::json_error(
                StatusCode::INTERNAL_SERVER_ERROR,
                "观察到账本转换首次执行授权复核暂时不可用",
            )
        }
    }
}

pub(crate) async fn handle_review_controlled_shadow_observation_ledger_transition_first_execution_authorization(
    State(state): State<Arc<AppState>>,
    headers: HeaderMap,
...
pub(crate) async fn controlled_shadow_observation_ledger_transition_first_execution_authorization_readiness_summary(
    state: &AppState,
) -> Result<
    ControlledShadowObservationLedgerTransitionFirstExecutionAuthorizationReadinessSummary,
    String,
> {
...
#[allow(dead_code)]
pub(crate) async fn observation_ledger_transition_first_execution_authorizations_for_future_claim(
    state: &AppState,
    now: DateTime<Utc>,
) -> Result<
    Vec<ApprovedControlledShadowObservationLedgerTransitionFirstExecutionAuthorization>,
    String,
> {
...
async fn build_registry(
    state: &AppState,
    now: DateTime<Utc>,
) -> Result<ControlledShadowObservationLedgerTransitionFirstExecutionAuthorizationRegistry, String>
{
    let runners =
        observation_ledger_transition_runners_for_first_execution_authorization_review(state)
            .await?;
    let claimed_review_ids = super::historical_outcome_offline_dataset_feature_label_join_target_training_sealed_holdout_evaluation_controlled_shadow_experiment_forward_observation_first_natural_forward_cycle_observation_ledger_transition_execution_attempt_claims::claimed_observation_ledger_transition_first_execution_authorization_review_ids(state).await?;
    ...
    for runner in runners {
        ...
        items.push(
            ControlledShadowObservationLedgerTransitionFirstExecutionAuthorizationItem {
                runner,
                artifact_inspection,
                latest_review,
    ...
    let approved_runner_count = items
        ...
        .filter(|item| {
            item.latest_review.as_ref().is_some_and(|review| {
                review.one_future_claim_first_observation_ledger_transition_attempt_authorized
            })
        })
        .count();
    ...
    let authorization_status = if runner_count == 0 {
        "waiting_for_current_stage_119_observation_ledger_transition_isolated_runner"
    } else if future_claim_eligible_count > 0 {
        "approved_for_one_future_stage_121_claim_first_attempt_not_started"
        ...
        "waiting_for_independent_first_observation_ledger_transition_execution_authorization_review"
    };
    Ok(
        ControlledShadowObservationLedgerTransitionFirstExecutionAuthorizationRegistry {
            ...
            scope: "Stage 120 只允许完整 Stage 51–119 责任链之外的新复核者，在服务端看到只读常规工件及自哈希 manifest、重新计算工件 SHA-256 并核对代码版本、复现步骤和隔离合同后，授予 24 小时内最多一次的未来 Stage 121 claim-first 资格。opening portfolio snapshot 仍缺失、金融事件白名单仍为空；未来尝试最多只能产生非财务 notice 候选，不得形成权威账本状态。当前没有入口、runtime、载荷挂载/读取、转换执行、候选输出、账本事件、持仓、现金、净值/绩效、模型/指标、训练、reward、订单、券商或交易能力。".to_string(),
        },
    )
}
...
async fn review_once(
...
) -> Result<ControlledShadowObservationLedgerTransitionFirstExecutionAuthorizationReview, String> {
    if !valid_id(isolated_runner_id) || request.expected_isolated_runner_id != isolated_runner_id {
        return Err("Stage 119 隔离 runner ID 无效或与路径不一致".to_string());
    }
    ...
    let runner =
        observation_ledger_transition_runners_for_first_execution_authorization_review(state)
            ...
            .ok_or_else(|| "当前没有这条绑定有效且可独立复核的 Stage 119 runner".to_string())?;
    ...
    {
        return Err("Stage 120 授权复核链已经变化，请刷新后重试".to_string());
    }
...
fn validate_expected_binding(
    ...
    validate_observation_ledger_transition_isolated_runner_for_review(runner)?;
    ...
    {
        return Err("Stage 111–119 runner、工件身份或完整上游绑定已经变化".to_string());
    }
    Ok(())
}
...
fn new_review(
    ...
    latest: Option<&ControlledShadowObservationLedgerTransitionFirstExecutionAuthorizationReview>,
    reviewer_id: &str,
    request: ReviewControlledShadowObservationLedgerTransitionFirstExecutionAuthorizationRequest,
    ...
    if latest.is_some_and(|review| {
        ...
        return Err("已批准的 Stage 120 授权复核链不得继续追加".to_string());
    }
    ...
    if request.reviewer_independent_from_stage_119_builder_and_complete_prior_chain_confirmed
        != independent
    {
        return Err("复核者独立性确认与 Stage 51–119 及工件构建者责任链不一致".to_string());
    }
    ...
    if request.artifact_builder_and_reviewer_separation_confirmed != builder_separated {
        return Err("工件构建者与 Stage 120 复核者分离确认不一致".to_string());
    }
    let mut review = ControlledShadowObservationLedgerTransitionFirstExecutionAuthorizationReview {
        ...
        exact_current_stage_51_through_stage_119_binding_confirmed: request
            .exact_current_stage_51_through_stage_119_binding_confirmed,
        reviewer_independent_from_stage_119_builder_and_complete_prior_chain_confirmed: request
            .reviewer_independent_from_stage_119_builder_and_complete_prior_chain_confirmed,
        ...
        all_eight_observation_ledger_transition_functions_and_canonical_schemas_remain_bound_confirmed: request
            .all_eight_observation_ledger_transition_functions_and_canonical_schemas_remain_bound_confirmed,
        ...
        future_input_only_stage_114_admitted_read_only_content_addressed_output_confirmed:
            request.future_input_only_stage_114_admitted_read_only_content_addressed_output_confirmed,
        future_output_content_addressed_create_once_untrusted_and_independently_validated_confirmed:
            request.future_output_content_addressed_create_once_untrusted_and_independently_validated_confirmed,
        opening_portfolio_snapshot_absent_and_financial_event_allowlist_empty_confirmed:
            request.opening_portfolio_snapshot_absent_and_financial_event_allowlist_empty_confirmed,
        future_financial_events_require_separately_admitted_opening_snapshot_confirmed:
            request.future_financial_events_require_separately_admitted_opening_snapshot_confirmed,
        future_attempt_limited_to_non_financial_notice_candidate_without_authoritative_state_confirmed:
            request.future_attempt_limited_to_non_financial_notice_candidate_without_authoritative_state_confirmed,
        ...
        authorization_single_use_24_hour_expiry_and_stage_121_claim_separation_confirmed: request
            .authorization_single_use_24_hour_expiry_and_stage_121_claim_separation_confirmed,
        no_runtime_entrypoint_mount_input_read_observation_ledger_transition_execution_or_candidate_output_confirmed: request
            .no_runtime_entrypoint_mount_input_read_observation_ledger_transition_execution_or_candidate_output_confirmed,
        ...
        no_authoritative_ledger_event_position_cash_nav_performance_model_metric_training_reward_order_broker_or_trading_confirmed:
            request.no_authoritative_ledger_event_position_cash_nav_performance_model_metric_training_reward_order_broker_or_trading_confirmed,
        approval_only_opens_future_stage_121_claim_first_attempt_confirmed: request
            .approval_only_opens_future_stage_121_claim_first_attempt_confirmed,
        ...
        one_future_claim_first_observation_ledger_transition_attempt_authorized: false,
    ...
    let approved = review.verdict
        == ControlledShadowObservationLedgerTransitionFirstExecutionAuthorizationVerdict::ApprovedForOneFutureClaimFirstObservationLedgerTransitionAttempt;
    review.one_future_claim_first_observation_ledger_transition_attempt_authorized =
...
fn review_checks(
    ...
    review.exact_current_stage_51_through_stage_119_binding_confirmed
        && review.reviewer_independent_from_stage_119_builder_and_complete_prior_chain_confirmed
        ...
        && review.all_eight_observation_ledger_transition_functions_and_canonical_schemas_remain_bound_confirmed
        ...
        && review.future_input_only_stage_114_admitted_read_only_content_addressed_output_confirmed
        && review.future_output_content_addressed_create_once_untrusted_and_independently_validated_confirmed
        && review.opening_portfolio_snapshot_absent_and_financial_event_allowlist_empty_confirmed
        && review.future_financial_events_require_separately_admitted_opening_snapshot_confirmed
        && review.future_attempt_limited_to_non_financial_notice_candidate_without_authoritative_state_confirmed
        && review.provider_publication_time_remains_unverified_until_separate_evidence_confirmed
        && review.authorization_single_use_24_hour_expiry_and_stage_121_claim_separation_confirmed
        && review.no_runtime_entrypoint_mount_input_read_observation_ledger_transition_execution_or_candidate_output_confirmed
        && review.no_environment_secret_network_tool_subprocess_or_production_io_confirmed
        && review.no_authoritative_ledger_event_position_cash_nav_performance_model_metric_training_reward_order_broker_or_trading_confirmed
        && review.approval_only_opens_future_stage_121_claim_first_attempt_confirmed
...
fn authority_closed(
    ...
    !review.authorization_claimed
        ...
        && !review.input_read
        && !review.observation_ledger_transition_executed
        && !review.candidate_output_created
...
#[allow(dead_code)]
pub(crate) fn validate_observation_ledger_transition_first_execution_authorization_for_claim(
    review: &ControlledShadowObservationLedgerTransitionFirstExecutionAuthorizationReview,
) -> Result<(), String> {
    validate_review(review, &review.runner)
}
...
fn validate_review(
    ...
    {
        return Err("Stage 120 观察到账本转换首次执行授权复核无效、漂移或越权".to_string());
    }
    Ok(())
}
...
async fn inspect_artifact(
    state: &AppState,
    runner: &ControlledShadowObservationLedgerTransitionIsolatedRunnerRecord,
) -> Result<ControlledShadowObservationLedgerTransitionArtifactInspection, String> {
    let directory = artifact_directory(state, runner);
    let custody_locator = format!(
        "controlled-shadow-observation-ledger-transition-reproduced-artifacts/{}/{}",
    ...
    let manifest: ControlledShadowObservationLedgerTransitionReproducedArtifactManifest =
    ...
    if validate_manifest(&manifest, runner).is_err() {
        return Ok(
            ControlledShadowObservationLedgerTransitionArtifactInspection {
                custody_locator,
...
#[allow(dead_code)]
pub(crate) async fn read_revalidated_observation_ledger_transition_artifact_for_execution(
    state: &AppState,
    review: &ControlledShadowObservationLedgerTransitionFirstExecutionAuthorizationReview,
) -> Result<Vec<u8>, String> {
    validate_observation_ledger_transition_first_execution_authorization_for_claim(review)?;
    let inspection = inspect_artifact(state, &review.runner).await?;
    if !artifact_inspection_matches_review(&inspection, review) {
        return Err("Stage 120 工件或 manifest 在 Stage 122 执行前复核失败".to_string());
    }
    let path = artifact_directory(state, &review.runner).join(ARTIFACT_FILE_NAME);
    let metadata = tokio::fs::symlink_metadata(&path)
        .await
        .map_err(|_| "Stage 122 无法重新打开固定观察到账本转换工件".to_string())?;
    if !safe_read_only_regular_file(&metadata, MAX_ARTIFACT_BYTES) {
        return Err("Stage 122 固定观察到账本转换工件不再是只读常规文件".to_string());
    }
    let bytes = tokio::fs::read(path)
        .await
        .map_err(|_| "Stage 122 无法读取固定观察到账本转换工件".to_string())?;
    if sha256_bytes(&bytes) != review.server_computed_artifact_sha256
        || bytes.len() as u64 != review.server_observed_artifact_byte_length
    {
        return Err("Stage 122 固定观察到账本转换工件摘要或长度漂移".to_string());
    }
    Ok(bytes)
}
...
fn artifact_inspection_matches_review(
    inspection: &ControlledShadowObservationLedgerTransitionArtifactInspection,
    review: &ControlledShadowObservationLedgerTransitionFirstExecutionAuthorizationReview,
) -> bool {
...
fn validate_manifest(
    manifest: &ControlledShadowObservationLedgerTransitionReproducedArtifactManifest,
    runner: &ControlledShadowObservationLedgerTransitionIsolatedRunnerRecord,
) -> Result<(), String> {
    let contract = &runner.runner_contract;
    let valid = manifest.schema_version == MANIFEST_SCHEMA_VERSION
        ...
        && !contract.opening_portfolio_snapshot_present
        && contract.financial_event_allowlist.is_empty()
        && contract.financial_event_allowlist_empty_without_opening_snapshot_required
        && contract.non_financial_observation_notice_only_without_opening_snapshot
        && !contract.future_output_authoritative_financial_state_allowed
        ...
        && manifest.stage_114_admitted_input_was_not_read;
    valid
        .then_some(())
        .ok_or_else(|| "Stage 120 工件复现 manifest 无效或与 Stage 119 漂移".to_string())
}
...
async fn read_reviews(
    state: &AppState,
    runner: &ControlledShadowObservationLedgerTransitionIsolatedRunnerRecord,
) -> Result<Vec<ControlledShadowObservationLedgerTransitionFirstExecutionAuthorizationReview>, String>
{
        ...
        .map_err(|error| error.to_string())?
    {
        ...
        let review: ControlledShadowObservationLedgerTransitionFirstExecutionAuthorizationReview =
        ...
        {
            return Err("Stage 120 授权复核链重复或文件名错误".to_string());
        }
        reviews.push(review);
    }
    Ok(reviews)
...
fn latest_review_from_records(
    reviews: &[ControlledShadowObservationLedgerTransitionFirstExecutionAuthorizationReview],
) -> Result<
    Option<ControlledShadowObservationLedgerTransitionFirstExecutionAuthorizationReview>,
    String,
> {
    ...
    let tips = reviews
        ...
        .collect::<Vec<_>>();
    if tips.len() != 1 {
        return Err("Stage 120 授权复核链 tip 数量无效".to_string());
    }
    if reviews.iter().any(|review| {
        ...
        return Err("Stage 120 批准必须终止复核链".to_string());
    }
    let mut cursor = Some(tips[0]);
    let mut visited = BTreeSet::new();
    while let Some(review) = cursor {
        if !visited.insert(review.review_id.clone()) {
            return Err("Stage 120 授权复核链存在环".to_string());
        }
        cursor = match (&review.previous_review_id, &review.previous_review_sha256) {
            (Some(id), Some(hash)) => {
                let previous = by_id
                    .get(id.as_str())
                    .ok_or_else(|| "Stage 120 授权复核链断裂".to_string())?;
                if previous.review_sha256 != *hash {
                    return Err("Stage 120 授权复核链前序摘要不一致".to_string());
                }
                Some(*previous)
            }
            (None, None) => None,
            _ => return Err("Stage 120 授权复核链前序链接无效".to_string()),
        };
    }
    if visited.len() != reviews.len() {
        return Err("Stage 120 授权复核链未完全连通".to_string());
    }
    for review in reviews {
        ...
        {
            return Err("Stage 120 授权复核责任链不一致".to_string());
        }
    }
...
fn fingerprint_without<T: Serialize>(value: &T, fields: &[&str]) -> Result<String, String> {
    ...
    let object = value
        .as_object_mut()
        .ok_or_else(|| "Stage 120 指纹载荷无效".to_string())?;
    for field in fields {
        object.remove(*field);
    }
    Ok(sha256_bytes(
...
fn artifact_directory(
    ...
    decision_root(state)
        .join("controlled-shadow-observation-ledger-transition-reproduced-artifacts")
...
fn review_directory(
    ...
    decision_root(state)
        .join(
            "controlled-shadow-observation-ledger-transition-first-execution-authorization-reviews",
        )
        .join(&runner.isolated_runner_id)
}
...
async fn acquire_lock(state: &AppState, isolated_runner_id: &str) -> Result<ReviewLock, String> {
    ...
    let path = directory.join(format!(
        "controlled-shadow-observation-ledger-transition-first-execution-{isolated_runner_id}.lock"
    ));
    ...
    tokio::fs::OpenOptions::new()
        ...
        .open(&path)
        .await
        .map_err(|_| "已有同一 Stage 120 授权复核正在进行".to_string())?;
    Ok(ReviewLock(path))
}
...
mod tests {
    ...
    #[test]
    fn stage_120_has_no_ledger_transition_or_trading_entrypoint() {
        let capability_flags = [false; 20];
        assert!(capability_flags.into_iter().all(|value| !value));
        assert_eq!(
            NEXT_GATE,
            "stage_121_claim_first_observation_ledger_transition_execution_attempt"
        );
    }
