//! Stage 100 chain-external first-execution authorization review for one exact Stage 99 market-data
//! parser runner specification.
//!
...
//! artifact itself. Approval expires after 24 hours and only exposes one future Stage 101
//! claim-first attempt candidate. This module never executes the artifact, mounts or reads a raw
//! market-data payload, creates parsed rows, starts observation, or grants portfolio/trading power.
...
use super::historical_outcome_offline_dataset_feature_label_join_target_training_sealed_holdout_evaluation_controlled_shadow_experiment_forward_observation_first_natural_forward_cycle_market_data_parser_isolated_runners::{
    ControlledShadowMarketDataParserIsolatedRunnerRecord,
    market_data_parser_runners_for_first_execution_authorization_review,
    validate_market_data_parser_isolated_runner_for_review,
};
use crate::state::AppState;

const REGISTRY_SCHEMA_VERSION: &str =
    "hone-controlled-shadow-market-data-parser-first-execution-authorization-registry-v1";
const MANIFEST_SCHEMA_VERSION: &str =
    "hone-controlled-shadow-market-data-parser-reproduced-artifact-manifest-v1";
const REVIEW_SCHEMA_VERSION: &str = "hone-controlled-shadow-market-data-parser-first-execution-authorization-review-v1-server-rehashed-artifact";
const POLICY_VERSION: &str = "hone-controlled-shadow-market-data-parser-first-execution-authorization-v1-server-rehashed-single-use-24h";
...
const NEXT_GATE: &str = "stage_101_claim_first_market_data_parser_execution_attempt";

#[derive(Debug, Clone, Serialize, Deserialize, PartialEq, Eq)]
#[serde(rename_all = "snake_case")]
pub(crate) enum ControlledShadowMarketDataParserFirstExecutionAuthorizationVerdict {
    ApprovedForOneFutureClaimFirstParserAttempt,
    ChangesRequestedRebuildArtifact,
    Rejected,
}

#[derive(Debug, Clone, Serialize, Deserialize, PartialEq, Eq)]
pub(crate) struct ControlledShadowMarketDataParserReproducedArtifactManifest {
    ...
    pub raw_market_data_was_not_read: bool,
}

#[derive(Debug, Clone, Serialize)]
pub(crate) struct ControlledShadowMarketDataParserArtifactInspection {
    pub custody_locator: String,
    pub manifest_present: bool,
    pub artifact_present: bool,
    pub manifest: Option<ControlledShadowMarketDataParserReproducedArtifactManifest>,
...
pub(crate) struct ReviewControlledShadowMarketDataParserFirstExecutionAuthorizationRequest {
    ...
    rationale: String,
    exact_current_stage_51_through_stage_99_binding_confirmed: bool,
    reviewer_independent_from_stage_99_builder_and_complete_prior_chain_confirmed: bool,
    ...
    all_eight_parser_functions_and_canonical_schemas_remain_bound_confirmed: bool,
    strict_source_calendar_action_numeric_and_failure_semantics_preserved_confirmed: bool,
    no_deduplication_forward_fill_interpolation_fallback_or_inferred_actions_confirmed: bool,
    ...
    future_input_only_stage_94_validated_read_only_content_addressed_receipt_payloads_confirmed:
        bool,
    future_output_create_once_untrusted_independently_validated_no_market_interpretation_or_order_intent_confirmed:
        bool,
    source_available_at_remains_unverified_until_separate_evidence_confirmed: bool,
    authorization_single_use_24_hour_expiry_and_stage_101_claim_separation_confirmed: bool,
    no_runtime_entrypoint_mount_payload_read_parser_execution_or_parsed_rows_confirmed: bool,
    ...
    no_observation_ledger_position_performance_model_metric_training_reward_order_broker_or_trading_confirmed:
        bool,
    approval_only_opens_future_stage_101_claim_first_attempt_confirmed: bool,
    no_unconfirmed_hari_or_old_wang_logic_claimed: bool,
}

#[derive(Debug, Clone, Serialize, Deserialize, PartialEq, Eq)]
pub(crate) struct ControlledShadowMarketDataParserFirstExecutionAuthorizationReview {
    pub schema_version: String,
    ...
    pub artifact_manifest: ControlledShadowMarketDataParserReproducedArtifactManifest,
    ...
    pub verdict: ControlledShadowMarketDataParserFirstExecutionAuthorizationVerdict,
    pub rationale: String,
    pub exact_current_stage_51_through_stage_99_binding_confirmed: bool,
    pub reviewer_independent_from_stage_99_builder_and_complete_prior_chain_confirmed: bool,
    ...
    pub all_eight_parser_functions_and_canonical_schemas_remain_bound_confirmed: bool,
    pub strict_source_calendar_action_numeric_and_failure_semantics_preserved_confirmed: bool,
    pub no_deduplication_forward_fill_interpolation_fallback_or_inferred_actions_confirmed: bool,
    ...
    pub future_input_only_stage_94_validated_read_only_content_addressed_receipt_payloads_confirmed:
        bool,
    pub future_output_create_once_untrusted_independently_validated_no_market_interpretation_or_order_intent_confirmed:
        bool,
    pub source_available_at_remains_unverified_until_separate_evidence_confirmed: bool,
    pub authorization_single_use_24_hour_expiry_and_stage_101_claim_separation_confirmed: bool,
    pub no_runtime_entrypoint_mount_payload_read_parser_execution_or_parsed_rows_confirmed: bool,
    ...
    pub no_observation_ledger_position_performance_model_metric_training_reward_order_broker_or_trading_confirmed:
        bool,
    pub approval_only_opens_future_stage_101_claim_first_attempt_confirmed: bool,
    pub no_unconfirmed_hari_or_old_wang_logic_claimed: bool,
    pub one_shot_execution_attempt_limit: u8,
    pub one_future_claim_first_parser_attempt_authorized: bool,
...
#[derive(Debug, Clone, Serialize)]
pub(crate) struct ControlledShadowMarketDataParserFirstExecutionAuthorizationItem {
    pub runner: ControlledShadowMarketDataParserIsolatedRunnerRecord,
    pub artifact_inspection: ControlledShadowMarketDataParserArtifactInspection,
    pub latest_review: Option<ControlledShadowMarketDataParserFirstExecutionAuthorizationReview>,
    pub authorization_unexpired: bool,
    pub future_claim_eligible: bool,
}

#[derive(Debug, Clone, Serialize)]
pub(crate) struct ControlledShadowMarketDataParserFirstExecutionAuthorizationRegistry {
    pub schema_version: String,
    pub policy_version: String,
    pub items: Vec<ControlledShadowMarketDataParserFirstExecutionAuthorizationItem>,
...
#[derive(Debug, Clone)]
pub(crate) struct ControlledShadowMarketDataParserFirstExecutionAuthorizationReadinessSummary {
    pub runner_count: usize,
    pub artifact_verified_runner_count: usize,
    pub artifact_pending_runner_count: usize,
    pub review_eligible_runner_count: usize,
...
#[derive(Debug, Clone)]
#[allow(dead_code)]
pub(crate) struct ApprovedControlledShadowMarketDataParserFirstExecutionAuthorization {
    pub runner: ControlledShadowMarketDataParserIsolatedRunnerRecord,
    pub review: ControlledShadowMarketDataParserFirstExecutionAuthorizationReview,
}

pub(crate) async fn handle_get_controlled_shadow_market_data_parser_first_execution_authorizations(
    ...
    match build_registry(&state, Utc::now()).await {
        ...
        Err(error) => {
            warn!(%error, "market-data parser first-execution authorization registry failed");
            crate::routes::json_error(
                StatusCode::INTERNAL_SERVER_ERROR,
                "行情 parser 首次执行授权复核暂时不可用",
            )
        }
    }
}

pub(crate) async fn handle_review_controlled_shadow_market_data_parser_first_execution_authorization(
    State(state): State<Arc<AppState>>,
    headers: HeaderMap,
    AxumPath(isolated_runner_id): AxumPath<String>,
    Json(request): Json<ReviewControlledShadowMarketDataParserFirstExecutionAuthorizationRequest>,
) -> Response {
    let admin =
...
pub(crate) async fn controlled_shadow_market_data_parser_first_execution_authorization_readiness_summary(
    state: &AppState,
) -> Result<ControlledShadowMarketDataParserFirstExecutionAuthorizationReadinessSummary, String> {
    let value = build_registry(state, Utc::now()).await?;
    Ok(
        ControlledShadowMarketDataParserFirstExecutionAuthorizationReadinessSummary {
...
#[allow(dead_code)]
pub(crate) async fn market_data_parser_first_execution_authorizations_for_future_claim(
    state: &AppState,
    now: DateTime<Utc>,
) -> Result<Vec<ApprovedControlledShadowMarketDataParserFirstExecutionAuthorization>, String> {
...
async fn build_registry(
    state: &AppState,
    now: DateTime<Utc>,
) -> Result<ControlledShadowMarketDataParserFirstExecutionAuthorizationRegistry, String> {
    let runners =
        market_data_parser_runners_for_first_execution_authorization_review(state).await?;
    let claimed_review_ids = super::historical_outcome_offline_dataset_feature_label_join_target_training_sealed_holdout_evaluation_controlled_shadow_experiment_forward_observation_first_natural_forward_cycle_market_data_parser_execution_attempt_claims::claimed_market_data_parser_first_execution_authorization_review_ids(state).await?;
    ...
    for runner in runners {
        ...
        items.push(
            ControlledShadowMarketDataParserFirstExecutionAuthorizationItem {
                runner,
                artifact_inspection,
                latest_review,
    ...
    let approved_runner_count = items
        ...
        .filter(|item| {
            item.latest_review
                .as_ref()
                .is_some_and(|review| review.one_future_claim_first_parser_attempt_authorized)
        })
        .count();
    ...
    let authorization_status = if runner_count == 0 {
        "waiting_for_current_stage_99_market_data_parser_isolated_runner"
    } else if future_claim_eligible_count > 0 {
        "approved_for_one_future_stage_101_claim_first_attempt_not_started"
        ...
        "waiting_for_independent_first_parser_execution_authorization_review"
    };
    Ok(
        ControlledShadowMarketDataParserFirstExecutionAuthorizationRegistry {
            ...
            scope: "Stage 100 只允许完整 Stage 51–99 责任链之外的新复核者，在服务端看到只读常规工件及自哈希 manifest、重新计算工件 SHA-256 并核对代码版本、复现步骤和隔离合同后，授予 24 小时内最多一次的未来 Stage 101 claim-first 资格。当前没有入口、runtime、载荷挂载/读取、parser 执行、解析行、观察、账本、持仓、绩效、模型/指标、训练、reward、订单、券商或交易能力。".to_string(),
        },
    )
}
...
async fn review_once(
...
) -> Result<ControlledShadowMarketDataParserFirstExecutionAuthorizationReview, String> {
    if !valid_id(isolated_runner_id) || request.expected_isolated_runner_id != isolated_runner_id {
        return Err("Stage 99 隔离 runner ID 无效或与路径不一致".to_string());
    }
    let _lock = acquire_lock(state, isolated_runner_id).await?;
    let runner = market_data_parser_runners_for_first_execution_authorization_review(state)
        .await?
        .into_iter()
        .find(|value| value.isolated_runner_id == isolated_runner_id)
        .ok_or_else(|| "当前没有这条绑定有效且可独立复核的 Stage 99 runner".to_string())?;
    ...
    {
        return Err("Stage 100 授权复核链已经变化，请刷新后重试".to_string());
    }
...
fn validate_expected_binding(
    ...
    if request.expected_isolated_runner_id != runner.isolated_runner_id
        ...
        || request.expected_validation_sha256 != implementation_contract.validation_sha256
        || request.expected_receipt_sha256 != implementation_contract.receipt_sha256
        || request.expected_claim_sha256 != implementation_contract.claim_sha256
        || request.expected_result_sha256 != implementation_contract.result_sha256
    {
        return Err("Stage 93–99 runner、工件身份或完整上游绑定已经变化".to_string());
    }
    Ok(())
}
...
fn new_review(
    ...
    latest: Option<&ControlledShadowMarketDataParserFirstExecutionAuthorizationReview>,
    reviewer_id: &str,
    request: ReviewControlledShadowMarketDataParserFirstExecutionAuthorizationRequest,
    submitted_at: DateTime<Utc>,
) -> Result<ControlledShadowMarketDataParserFirstExecutionAuthorizationReview, String> {
    if latest.is_some_and(|review| review.one_future_claim_first_parser_attempt_authorized) {
        return Err("已批准的 Stage 100 授权复核链不得继续追加".to_string());
    }
    ...
    if request.reviewer_independent_from_stage_99_builder_and_complete_prior_chain_confirmed
        != independent
    {
        return Err("复核者独立性确认与 Stage 51–99 及工件构建者责任链不一致".to_string());
    }
    ...
    if request.artifact_builder_and_reviewer_separation_confirmed != builder_separated {
        return Err("工件构建者与 Stage 100 复核者分离确认不一致".to_string());
    }
    let mut review = ControlledShadowMarketDataParserFirstExecutionAuthorizationReview {
        ...
        exact_current_stage_51_through_stage_99_binding_confirmed: request
            .exact_current_stage_51_through_stage_99_binding_confirmed,
        reviewer_independent_from_stage_99_builder_and_complete_prior_chain_confirmed: request
            .reviewer_independent_from_stage_99_builder_and_complete_prior_chain_confirmed,
        ...
        all_eight_parser_functions_and_canonical_schemas_remain_bound_confirmed: request
            .all_eight_parser_functions_and_canonical_schemas_remain_bound_confirmed,
        strict_source_calendar_action_numeric_and_failure_semantics_preserved_confirmed: request
            .strict_source_calendar_action_numeric_and_failure_semantics_preserved_confirmed,
        no_deduplication_forward_fill_interpolation_fallback_or_inferred_actions_confirmed: request
            .no_deduplication_forward_fill_interpolation_fallback_or_inferred_actions_confirmed,
        fixed_unprivileged_identity_read_only_root_ephemeral_workdir_and_resource_limits_confirmed:
        ...
        future_output_create_once_untrusted_independently_validated_no_market_interpretation_or_order_intent_confirmed:
            request.future_output_create_once_untrusted_independently_validated_no_market_interpretation_or_order_intent_confirmed,
        ...
        authorization_single_use_24_hour_expiry_and_stage_101_claim_separation_confirmed: request
            .authorization_single_use_24_hour_expiry_and_stage_101_claim_separation_confirmed,
        no_runtime_entrypoint_mount_payload_read_parser_execution_or_parsed_rows_confirmed: request
            .no_runtime_entrypoint_mount_payload_read_parser_execution_or_parsed_rows_confirmed,
        ...
        approval_only_opens_future_stage_101_claim_first_attempt_confirmed: request
            .approval_only_opens_future_stage_101_claim_first_attempt_confirmed,
        ...
        one_future_claim_first_parser_attempt_authorized: false,
    ...
    let approved = review.verdict
        == ControlledShadowMarketDataParserFirstExecutionAuthorizationVerdict::ApprovedForOneFutureClaimFirstParserAttempt;
    review.one_future_claim_first_parser_attempt_authorized =
...
fn review_checks(
    ...
    review.exact_current_stage_51_through_stage_99_binding_confirmed
        && review.reviewer_independent_from_stage_99_builder_and_complete_prior_chain_confirmed
        ...
        && review.all_eight_parser_functions_and_canonical_schemas_remain_bound_confirmed
        && review.strict_source_calendar_action_numeric_and_failure_semantics_preserved_confirmed
        && review.no_deduplication_forward_fill_interpolation_fallback_or_inferred_actions_confirmed
        && review.fixed_unprivileged_identity_read_only_root_ephemeral_workdir_and_resource_limits_confirmed
        && review.future_input_only_stage_94_validated_read_only_content_addressed_receipt_payloads_confirmed
        && review.future_output_create_once_untrusted_independently_validated_no_market_interpretation_or_order_intent_confirmed
        && review.source_available_at_remains_unverified_until_separate_evidence_confirmed
        && review.authorization_single_use_24_hour_expiry_and_stage_101_claim_separation_confirmed
        && review.no_runtime_entrypoint_mount_payload_read_parser_execution_or_parsed_rows_confirmed
        ...
        && review.approval_only_opens_future_stage_101_claim_first_attempt_confirmed
...
fn authority_closed(
    ...
    !review.authorization_claimed
        ...
        && !review.raw_payload_mount_present
        && !review.raw_payload_read
        && !review.parser_executed
...
pub(crate) fn validate_market_data_parser_first_execution_authorization_for_claim(
    review: &ControlledShadowMarketDataParserFirstExecutionAuthorizationReview,
) -> Result<(), String> {
    validate_review(review, &review.runner)
}
...
fn validate_review(
    ...
    {
        return Err("Stage 100 parser 首次执行授权复核无效、漂移或越权".to_string());
    }
    Ok(())
}
...
async fn inspect_artifact(
    state: &AppState,
    runner: &ControlledShadowMarketDataParserIsolatedRunnerRecord,
) -> Result<ControlledShadowMarketDataParserArtifactInspection, String> {
    let directory = artifact_directory(state, runner);
    let custody_locator = format!(
        "controlled-shadow-market-data-parser-reproduced-artifacts/{}/{}",
    ...
    let manifest: ControlledShadowMarketDataParserReproducedArtifactManifest =
    ...
    if validate_manifest(&manifest, runner).is_err() {
        return Ok(ControlledShadowMarketDataParserArtifactInspection {
            custody_locator,
    ...
    Ok(ControlledShadowMarketDataParserArtifactInspection {
        custody_locator,
        manifest_present: true,
        artifact_present: true,
        manifest: Some(manifest),
...
pub(crate) async fn read_revalidated_market_data_parser_artifact_for_execution(
    state: &AppState,
    review: &ControlledShadowMarketDataParserFirstExecutionAuthorizationReview,
) -> Result<Vec<u8>, String> {
    validate_market_data_parser_first_execution_authorization_for_claim(review)?;
    let inspection = inspect_artifact(state, &review.runner).await?;
    if !artifact_inspection_matches_review(&inspection, review) {
        return Err("Stage 100 工件或 manifest 在 Stage 102 执行前复核失败".to_string());
    }
    let path = artifact_directory(state, &review.runner).join(ARTIFACT_FILE_NAME);
    let metadata = tokio::fs::symlink_metadata(&path)
        .await
        .map_err(|_| "Stage 102 无法重新打开固定 parser 工件".to_string())?;
    if !safe_read_only_regular_file(&metadata, MAX_ARTIFACT_BYTES) {
        return Err("Stage 102 固定 parser 工件不再是只读常规文件".to_string());
    }
    let bytes = tokio::fs::read(path)
        .await
        .map_err(|_| "Stage 102 无法读取固定 parser 工件".to_string())?;
    if sha256_bytes(&bytes) != review.server_computed_artifact_sha256
        || bytes.len() as u64 != review.server_observed_artifact_byte_length
    {
        return Err("Stage 102 固定 parser 工件摘要或长度漂移".to_string());
    }
    Ok(bytes)
}
...
fn artifact_inspection_matches_review(
    inspection: &ControlledShadowMarketDataParserArtifactInspection,
    review: &ControlledShadowMarketDataParserFirstExecutionAuthorizationReview,
) -> bool {
...
fn pending_inspection(
    ...
    status: &str,
) -> ControlledShadowMarketDataParserArtifactInspection {
    ControlledShadowMarketDataParserArtifactInspection {
        custody_locator,
        manifest_present,
        artifact_present,
...
fn validate_manifest(
    manifest: &ControlledShadowMarketDataParserReproducedArtifactManifest,
    runner: &ControlledShadowMarketDataParserIsolatedRunnerRecord,
) -> Result<(), String> {
    let contract = &runner.runner_contract;
    let valid = manifest.schema_version == MANIFEST_SCHEMA_VERSION
        ...
        && manifest.raw_market_data_was_not_read;
    valid
        .then_some(())
        .ok_or_else(|| "Stage 100 工件复现 manifest 无效或与 Stage 99 漂移".to_string())
}
...
async fn latest_review(
    state: &AppState,
    runner: &ControlledShadowMarketDataParserIsolatedRunnerRecord,
) -> Result<Option<ControlledShadowMarketDataParserFirstExecutionAuthorizationReview>, String> {
...
async fn read_reviews(
    state: &AppState,
    runner: &ControlledShadowMarketDataParserIsolatedRunnerRecord,
) -> Result<Vec<ControlledShadowMarketDataParserFirstExecutionAuthorizationReview>, String> {
        ...
        .map_err(|error| error.to_string())?
    {
        ...
        let review: ControlledShadowMarketDataParserFirstExecutionAuthorizationReview =
        ...
        {
            return Err("Stage 100 授权复核链重复或文件名错误".to_string());
        }
        reviews.push(review);
    }
    Ok(reviews)
...
fn latest_review_from_records(
    reviews: &[ControlledShadowMarketDataParserFirstExecutionAuthorizationReview],
) -> Result<Option<ControlledShadowMarketDataParserFirstExecutionAuthorizationReview>, String> {
    if reviews.is_empty() {
        return Ok(None);
    }
    ...
    let tips = reviews
        ...
        .collect::<Vec<_>>();
    if tips.len() != 1 {
        return Err("Stage 100 授权复核链 tip 数量无效".to_string());
    }
    if reviews.iter().any(|review| {
        ...
        return Err("Stage 100 批准必须终止复核链".to_string());
    }
    let mut cursor = Some(tips[0]);
    let mut visited = BTreeSet::new();
    while let Some(review) = cursor {
        if !visited.insert(review.review_id.clone()) {
            return Err("Stage 100 授权复核链存在环".to_string());
        }
        cursor = match (&review.previous_review_id, &review.previous_review_sha256) {
            (Some(id), Some(hash)) => {
                let previous = by_id
                    .get(id.as_str())
                    .ok_or_else(|| "Stage 100 授权复核链断裂".to_string())?;
                if previous.review_sha256 != *hash {
                    return Err("Stage 100 授权复核链前序摘要不一致".to_string());
                }
                Some(*previous)
            }
            (None, None) => None,
            _ => return Err("Stage 100 授权复核链前序链接无效".to_string()),
        };
    }
    if visited.len() != reviews.len() {
        return Err("Stage 100 授权复核链未完全连通".to_string());
    }
    for review in reviews {
        ...
        {
            return Err("Stage 100 授权复核责任链不一致".to_string());
        }
    }
...
fn fingerprint_without<T: Serialize>(value: &T, fields: &[&str]) -> Result<String, String> {
    ...
    let object = value
        .as_object_mut()
        .ok_or_else(|| "Stage 100 指纹载荷无效".to_string())?;
    for field in fields {
        object.remove(*field);
    }
    Ok(sha256_bytes(
...
fn artifact_directory(
    ...
    decision_root(state)
        .join("controlled-shadow-market-data-parser-reproduced-artifacts")
...
fn review_directory(
    ...
    decision_root(state)
        .join("controlled-shadow-market-data-parser-first-execution-authorization-reviews")
        .join(&runner.isolated_runner_id)
}
...
async fn acquire_lock(state: &AppState, isolated_runner_id: &str) -> Result<ReviewLock, String> {
    ...
    let path = directory.join(format!(
        "controlled-shadow-market-data-parser-first-execution-{isolated_runner_id}.lock"
    ));
    ...
    tokio::fs::OpenOptions::new()
        ...
        .open(&path)
        .await
        .map_err(|_| "已有同一 Stage 100 授权复核正在进行".to_string())?;
    Ok(ReviewLock(path))
}
...
mod tests {
    ...
    #[test]
    fn stage_100_has_no_parser_or_trading_entrypoint() {
        let capability_flags = [false; 20];
        assert!(capability_flags.into_iter().all(|value| !value));
        assert_eq!(
            NEXT_GATE,
            "stage_101_claim_first_market_data_parser_execution_attempt"
        );
    }
