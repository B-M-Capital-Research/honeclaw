...
3. **护城河**：单独回答“客户为什么难以换掉它”，验证技术/良率、客户认证、数据/生态、转换成本是否正在加强或削弱。
4. **产业稀缺性**：单独回答需求相对有效供给是否真的紧张、持续多久，以及价格、产能、库存和替代路线会不会消除稀缺。
5. **公司差异化**：单独回答同一产业里为什么由这家公司而不是同行获得收入、利润和现金流；不得把行业景气当成公司差异化。
6. **估值**：采用研究卡指定的方法，并列出最敏感的 2–3 个假设。没有第三方一致预期不等于不能估值：只要当前价格和一手 EPS/现金流输入存在，至少给出 12x/15x/18x 等机械反向估值门槛并注明它不是目标价；输入仍不足时才明确“不计估值分”。
