...
const CONTENT_ZH = {
  ...
  chat_page: {
    ...
    trail: {
      working: "工作轨迹",
      summary: "已完成 {count} 步 · 用时 {seconds}s",
      summary_untimed: "已完成 {count} 步",
      think_label: "思考摘要",
      expand: "查看完整思考轨迹",
    },
    attachments: {
    ...
    composer: {
      ...
      send_aria: "发送",
      stop_aria: "停止本轮回答",
      quota_remaining: "今日剩余 {count} 次",
      sheet_title: "添加与工具",
      attach_group: "附件",
      actions_group: "快捷入口",
      suggest_title: "推荐提问",
      suggest_hide: "收起推荐",
      finance_calendar_hint: "宏观日程与持仓财报，整理成一张图发到对话",
      influencer_tip: "大V观点速报",
      influencer_hint: "Serenity 等作者的最新推文与观点，每 15 分钟同步",
      data_center_hint: "走进一座 AI 数据中心，看懂算力背后的产业连接",
      community_hint: "社区的研究判断、市场观察与关键资料",
      proactive_tip: "持仓分析",
    ...
    workspace: {
      ...
      tools_label: "工具",
      tools_group_research: "研究工具",
      tools_research_desc: "红绿灯 · 大V速报 · 评级，今日一览",
      tools_group_daily: "每日研究",
      tools_group_intel: "情报与简报",
      tools_group_holdings: "我的持仓",
      tools_group_admin: "管理",
      tools_group_workflows: "工作流",
      tools_macro_title: "宏观红绿灯",
      tools_macro_desc: "领先周期与消费风险",
      tools_ai_title: "AI 红绿灯",
      tools_ai_desc: "AI 增长可持续性",
      tools_ratings_title: "公司评级",
      tools_ratings_desc: "52 家研究基线",
      tools_valuation_desc: "三情景估值与关键假设",
      tools_chain_title: "关键事件链",
      tools_chain_desc: "产业里程碑与线索",
      tools_weekly_title: "周度简报",
      tools_weekly_desc: "上周回顾 · 下周日程",
      tools_news_title: "持仓重点新闻",
      tools_news_desc: "按你的持仓筛选",
      tools_position_title: "仓位管理",
      tools_position_desc: "评分 × 宏观 × 新闻",
      tools_library_desc: "知识源与投稿核验",
      tools_close: "关闭",
      ...
      restore_notice: "会话暂时未同步，你仍可查看当前页面。",
      reconnect: "重新连接",
      community_action: "查看社区动态",
      data_center_tip: "3D 数据中心",
    ...
    community_page: {
      ...
      resources: "社区资源",
      close_preview: "关闭预览",
      pdf_unsupported: "暂时无法预览这份 PDF",
      pdf_fallback: "请尝试下方“下载资源”，下载后可用 PDF 阅读器查看。",
      pdf_preparing: "正在载入 PDF 页面…",
      file_preview: "社区文件预览",
      pdf_slow: "PDF 载入较慢，也可下载后查看。",
      image: "社区图片",
      zoom_hint: "双指或滚轮缩放，放大后可拖动",
      pdf_controls_hint: "支持翻页与缩放，也可下载原文件",
      pdf_page: "第 {page} 页 / 共 {total} 页",
      pdf_previous: "上一页",
      pdf_next: "下一页",
      image_zoom: "图片缩放",
      zoom_out: "缩小",
      ...
      refresh: "刷新动态",
      refreshing: "正在刷新…",
      refresh_failed: "暂未获取到最新动态，请重试刷新。",
      ...
      community_file: "社区文件",
      not_archived: "附件尚未归档",
      not_archived_detail: "目前仅收录了附件名称，HONE 尚未保存可预览或下载的文件。",
      previously_restricted: "原采集时记录访问受限",
      previously_restricted_detail: "旧记录显示采集时访问受限，当前来源可用性尚未确认。HONE 未保存可下载的文件。",
      resource_unavailable: "附件暂不可用",
      resource_unavailable_detail: "当前无法提供此附件的预览或下载，可到来源群组查找。",
      resource_details_label: "查看附件说明：{name}",
      close_resource_details: "关闭附件说明",
      resource_name: "文件名",
      copy_resource_name: "复制文件名",
      resource_name_copied: "文件名已复制",
      resource_name_copy_failed: "复制失败，请选中文件名后复制。",
      open_source_group: "打开知识星球群组",
      source_group_hint: "进入来源群组后可按文件名查找。查看或下载仍需该群组的相应权限。",
      click_preview: "点击预览",
      click_download: "点击下载",
    ...
    activate_page: {
      ...
      payment_methods_prefix: "当前可用：",
      payment_methods_separator: "、",
      payment_method_card: "信用卡 / 借记卡",
      payment_method_alipay: "支付宝",
      payment_method_wechat_pay: "微信支付",
    ...
    misc: {
      ...
      startup_retry: "重新尝试",
      shell_user: "用户",
      disclaimer: "HONE 可能出错。内容仅供研究参考，不构成投资建议。",
    ...
    admin: {
      ...
      u_live: "实时统计",
      u_title: "使用统计",
      u_subtitle: "按运行时时区汇总网页、飞书及其它接入渠道；可切换渠道和追溯周期，跨渠道未绑定的账号分别计数。",
      u_collapse: "收起",
      u_expand: "展开",
      ...
      w_processing: "处理中…",
      w_add: "加入白名单",
      w_quota_note: "为防止误操作，每位管理员按运行时时区每天最多成功新增 5 人。",
      w_joined: "加入时间",
      w_last_login: "最近登录",
      w_status: "状态",
      w_actions: "操作",
    ...
    share: {
      ...
      strings: {
        ...
        rendering: "生成中…",
        included: "包含的消息",
        picker_hint: "从最近 4 条里勾选",
        font_size: "字号",
        font_s: "小",
        font_m: "标准",
        font_l: "大",
        font_xl: "特大",
        preview_label: "分享图片预览",
        card_disclaimer: "内容仅供研究参考，不构成投资建议",
        text_footer: "—— 来自 HONE 投资助手 · hone-claw.com",
      },
    },
  },
...
const CONTENT_EN: typeof CONTENT_ZH = {
  ...
  chat_page: {
    ...
    trail: {
      working: "Work trail",
      summary: "{count} steps · {seconds}s",
      summary_untimed: "{count} steps done",
      think_label: "Thinking",
      expand: "Show full reasoning",
    },
    attachments: {
      image_title: "Image",
      ...
      remove_aria: "Remove attachment",
    },
    composer: {
      quota_exhausted: "You've used today's chat quota",
      placeholder: "Ask HONE…",
      send_aria: "Send",
      stop_aria: "Stop this answer",
      quota_remaining: "{count} left today",
      sheet_title: "Add and tools",
      attach_group: "Attachments",
      actions_group: "Shortcuts",
      suggest_title: "Suggested questions",
      suggest_hide: "Hide suggestions",
      finance_calendar_hint: "Macro dates and your holdings' earnings, sent as one image",
      influencer_tip: "Commentator digest",
      influencer_hint: "Latest posts and takes from Serenity and other authors, synced every 15 minutes",
      data_center_hint: "Walk through an AI data center and its supply chain",
      community_hint: "Community research, market notes and key documents",
    ...
    workspace: {
      ...
      tools_label: "Tools",
      tools_group_research: "Research",
      tools_research_desc: "Signals, commentator digest and ratings at a glance",
      tools_group_daily: "Daily research",
      tools_group_intel: "Intel and briefs",
      tools_group_holdings: "My holdings",
      tools_group_admin: "Administration",
      tools_group_workflows: "Workflows",
      tools_macro_title: "Macro signal",
      tools_macro_desc: "Leading cycle and consumption risk",
      tools_ai_title: "AI signal",
      tools_ai_desc: "How sustainable AI growth looks",
      tools_ratings_title: "Company ratings",
      tools_ratings_desc: "52-company research baseline",
      tools_valuation_desc: "Three scenarios and their assumptions",
      tools_chain_title: "Key event chain",
      tools_chain_desc: "Industry milestones and clues",
      tools_weekly_title: "Weekly brief",
      tools_weekly_desc: "Last week reviewed, next week scheduled",
      tools_news_title: "Portfolio news",
      tools_news_desc: "Filtered by what you hold",
      tools_position_title: "Position management",
      tools_position_desc: "Ratings x macro x news",
      tools_library_desc: "Knowledge sources and submission review",
      tools_close: "Close",
      ...
      restore_notice: "The session is not synced yet; the current page is still readable.",
      reconnect: "Reconnect",
      community_action: "Community updates",
      data_center_tip: "3D data center",
    ...
    community_page: {
      ...
      pdf_unsupported: "This PDF could not be previewed",
      pdf_fallback: "Try Download below, then open the file in a PDF reader.",
      pdf_preparing: "Loading the PDF page…",
      file_preview: "Community file preview",
      pdf_slow: "The PDF is loading slowly. You can also download it to read.",
      image: "Community image",
      zoom_hint: "Pinch or scroll to zoom; drag once zoomed in",
      pdf_controls_hint: "Turn pages, zoom, or download the original file",
      pdf_page: "Page {page} of {total}",
      pdf_previous: "Previous page",
      pdf_next: "Next page",
      ...
      refresh_failed: "Could not retrieve the latest updates. Please refresh again.",
      ...
      not_archived: "Attachment not yet archived",
      not_archived_detail: "Only the attachment name has been recorded. HONE does not yet have a file to preview or download.",
      previously_restricted: "Access restricted during earlier capture",
      previously_restricted_detail: "An earlier capture recorded restricted access. Current source availability has not been confirmed, and HONE does not have a downloadable file.",
      resource_unavailable: "Attachment unavailable",
      resource_unavailable_detail: "Preview and download are currently unavailable. You can look for this attachment in the source group.",
      resource_details_label: "Attachment details: {name}",
      close_resource_details: "Close attachment details",
      resource_name: "Filename",
      copy_resource_name: "Copy filename",
      resource_name_copied: "Filename copied",
      resource_name_copy_failed: "Copy failed. Select the filename and copy it manually.",
      open_source_group: "Open Knowledge Planet group",
      source_group_hint: "Look for the filename in the source group. Viewing or downloading requires the appropriate group permissions.",
      click_preview: "Tap to preview",
    ...
    activate_page: {
      ...
      payment_methods_prefix: "Available now: ",
      payment_methods_separator: ", ",
      payment_method_card: "credit or debit card",
      payment_method_alipay: "Alipay",
      payment_method_wechat_pay: "WeChat Pay",
    ...
    misc: {
      ...
      shell_user: "User",
      disclaimer: "HONE can make mistakes. Content is for research reference only and is not investment advice.",
    ...
    admin: {
      ...
      u_subtitle: "Aggregated in runtime timezone across Web, Feishu and other channels. Channel and look-back are switchable; unlinked accounts are counted separately per channel.",
      u_collapse: "Collapse",
      u_expand: "Expand",
      ...
      w_quota_note: "To limit mistakes, each administrator can add at most 5 people per runtime-timezone day.",
      w_joined: "Joined",
    ...
    share: {
      ...
      strings: {
        ...
        rendering: "Rendering…",
        included: "Included messages",
        picker_hint: "Pick from the latest four",
        font_size: "Text size",
        font_s: "S",
        font_m: "M",
        font_l: "L",
        font_xl: "XL",
        preview_label: "Share image preview",
        card_disclaimer: "Research reference only; not investment advice",
        text_footer: "— from HONE, the investment research assistant · hone-claw.com",
      },
    },
  },
