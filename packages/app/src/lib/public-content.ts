...
const CONTENT_ZH = {
  ...
  chat_page: {
    ...
    workspace: {
      ...
      tools_research_desc: "红绿灯 · 评级 · 事件链，今日一览",
      ...
      tools_influencer_desc: "注册作者的公开观点",
...
const CONTENT_EN: typeof CONTENT_ZH = {
  ...
  chat_page: {
    ...
    workspace: {
      ...
      tools_research_desc: "Signals, ratings and event chains at a glance",
      ...
      tools_influencer_desc: "Registered authors, in public",
