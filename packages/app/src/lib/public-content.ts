...
const CONTENT_ZH = {
  ...
  chat_page: {
    ...
    composer: {
      ...
      finance_calendar_image_save_hint: "使用加减按钮放大并拖动画布，长按图片可存入照片",
...
const CONTENT_EN: typeof CONTENT_ZH = {
  ...
  chat_page: {
    ...
    composer: {
      ...
      finance_calendar_image_save_hint: "Use the zoom controls and pan the canvas, or long-press to save to Photos",
