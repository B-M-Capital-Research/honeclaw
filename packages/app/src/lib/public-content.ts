  ...
  chat_page: {
    ...
    share: {
      ...
      strings: {
        ...
        share: "系统分享",
        close_aria: "关闭",
        success_download: "图片已下载",
        success_copy_image: "图片已复制",
        success_copy_text: "文字已复制",
        success_share: "已分享",
        save_image_hint: "图片已打开，请长按保存到相册",
        error_download: "下载失败，请重试",
        error_copy_image: "复制失败，请改用下载",
        error_copy_text: "复制文字失败，请手动选择文本",
        error_render: "生成图片失败，请减少消息后重试",
        error_share: "分享已取消",
        error_system_share: "系统分享失败，请改用下载或复制",
        role_user: "我",
        role_assistant: "Hone",
  ...
  chat_page: {
    ...
    share: {
      ...
      strings: {
        ...
        subtitle: "Pick messages to include, then choose an export",
        select_all: "Select all",
        deselect_all: "Just this one",
        download: "Download",
        copy_image: "Copy image",
        copy_text: "Copy text",
        share: "Share…",
        close_aria: "Close",
        success_download: "Image downloaded",
        success_copy_image: "Image copied",
        success_copy_text: "Text copied",
        success_share: "Shared",
        save_image_hint: "Image opened. Long-press to save to Photos.",
        error_download: "Download failed. Please try again.",
        error_copy_image: "Copy failed — try Download instead",
        ...
        error_system_share: "System share failed. Try Download or Copy instead.",
        role_user: "You",
        role_assistant: "Hone",
