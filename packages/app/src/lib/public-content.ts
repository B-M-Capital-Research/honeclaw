...
const CONTENT_ZH = {
  ...
  chat_page: {
    ...
    composer: {
      ...
      finance_calendar_image_zoom: "放大查看",
      finance_calendar_image_save_hint: "双指缩放查看细节，长按图片可存入照片",
...
const CONTENT_EN: typeof CONTENT_ZH = {
  ...
  chat_page: {
    ...
    composer: {
      ...
      finance_calendar_image_zoom: "Zoom in",
      finance_calendar_image_save_hint: "Pinch to inspect details, or long-press to save to Photos",
