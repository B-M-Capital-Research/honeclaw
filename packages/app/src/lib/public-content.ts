...
const CONTENT_ZH = {
  ...
  plan: {
    eyebrow: "PLAN 与定价",
    title: "选择适合你的研究方式",
    sub: "HONE 核心永远开源。云端托管的 Pro 与 Team 计划正在打磨中，价格与权益将在正式上线时公布。",
    badge_current: "当前可用",
    badge_soon: "即将上线",
    price_tbd: "价格待公布",
    note: "本页为预留页面：档位与权益以正式上线为准，开源版能力不受任何影响。想第一时间获得云端内测名额，欢迎邮件联系 bm@hone-claw.com。",
    contact_cta: "联系我们",
    tiers: [
      {
        id: "free",
        ...
        features: ["全部核心研究能力", "数据完全本地自持", "7 大渠道接入", "社区支持"],
        cta: "GitHub 部署",
      },
      {
        id: "pro",
        ...
        period: "按月订阅",
        desc: "免部署的云端个人研究空间",
        features: ["云端托管与多端同步", "更高研究额度", "优先体验新能力", "重要事件推送提醒"],
        cta: "敬请期待",
      },
      {
        id: "team",
        ...
        period: "按席位",
        desc: "团队共享研究记忆与协作纪律",
        features: ["共享公司画像库", "成员与权限管理", "私有化部署选项", "专属支持"],
        cta: "联系我们",
      },
    ],
  },
...
const CONTENT_EN: typeof CONTENT_ZH = {
  ...
  plan: {
    ...
    title: "Pick how you want to research",
    sub: "The HONE core stays open source. Hosted Pro and Team plans are in the works — pricing and entitlements will be announced at launch.",
    badge_current: "Available now",
    badge_soon: "Coming soon",
    price_tbd: "Pricing TBA",
    note: "This is a reserved page: tiers and entitlements are subject to the official launch, and the open-source edition is never limited. Want early access to the cloud beta? Email bm@hone-claw.com.",
    ...
    tiers: [
      {
        ...
        features: ["All core research capabilities", "Your data stays local", "7 channel integrations", "Community support"],
      ...
      },
      {
        ...
        price: "In the works",
        period: "Monthly",
        desc: "A zero-deploy personal research space",
        features: ["Hosted, synced across devices", "Higher research quota", "Early access to new abilities", "Key-event notifications"],
        cta: "Coming soon",
      },
      {
        id: "team",
        ...
        price: "Custom",
        period: "Per seat",
        desc: "Shared research memory and team discipline",
        features: ["Shared company-profile library", "Members & permissions", "Private deployment options", "Dedicated support"],
        cta: "Contact us",
      },
    ],
  },
