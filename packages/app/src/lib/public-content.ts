...
const CONTENT_ZH = {
  ...
  chat_page: {
    ...
    workspace: {
      ...
      tools_influencer_title: "大V速报",
      tools_influencer_desc: "Serenity 等作者推文，每 15 分钟同步",
...
const CONTENT_EN: typeof CONTENT_ZH = {
  ...
  chat_page: {
    ...
    workspace: {
      ...
      tools_group_workflows: "Earnings workflows",
      ...
      tools_influencer_title: "Commentator digest",
      tools_influencer_desc: "Serenity and others, synced every 15 minutes",
