...
const CONTENT_ZH = {
  ...
  chat_page: {
    ...
    composer: {
      ...
      finance_calendar_months_label: "选择月份",
      finance_calendar_send: "生成并发送",
      finance_calendar_sending: "生成中…",
...
const CONTENT_EN: typeof CONTENT_ZH = {
  ...
  chat_page: {
    ...
    composer: {
      ...
      finance_calendar_months_label: "Choose a month",
      finance_calendar_send: "Generate and send",
      finance_calendar_sending: "Generating…",
