...
**系统架构**：[交互式架构图](./resources/architecture.html) — 克隆仓库后，在本地用浏览器打开该文件即可查看。

# 2. ✨ 核心特性 (Key Features)

- 🧠 **绝对理性的投研内核**：不附和、不盲从。在你做出投资决策时，它会基于数据和预设纪律进行交叉验证，指出你的逻辑漏洞。
- 📱 **全平台无缝接入**：支持 iMessage, 飞书 (Lark), Telegram, Discord，随时随地与你的投资大脑进行对话。
- 🗂️ **公司画像沉淀能力**：Hone 可以把公司主画像与关键事件时间线持续沉淀为 Markdown 档案，长期保留 thesis、核心经营指标、风险台账与重大变化，方便后续复盘与持续跟踪。
...
<p align="center">
  <em>公司画像（Company Profiles）功能面板：通过该界面集中管理长线研究记忆，无缝跟踪与审阅从日常聊天中积累下来的基本面逻辑与投资时间线。</em>
</p>
...
### 方案 A：通过 `curl | bash` 安装 macOS/Linux CLI bundle
...
2. [BiliBili: 巴芒投资](https://space.bilibili.com/224670487) — 欢迎关注，获取投研内容

3. [Discord](https://discord.gg/TyDNfYXDGF): 通过邀请码链接 (https://discord.gg/TyDNfYXDGF) 加入我们的社区频道
